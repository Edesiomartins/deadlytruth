    ...
    >
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <p className="text-center text-sm text-lightGray mb-8 uppercase tracking-wider">Login</p>
          ...
          <p className="text-center text-lightGray text-sm mt-6">
            Não tem uma conta?{' '}
            <Link to="/register" className="text-primaryRed hover:underline font-semibold">
              Registre-se aqui
            </Link>
          </p>
        </div>
